...
The past is what I am living on` 
  ...
  },
  {
    id: 'sendoff', 
    title: 'SENDOFF', 
    subtitle: 'The Best Project', 
    releasedAt: '2026-05-29', 
    releaseLabel: 'Released May 29, 2026', 
    artistId: 'ven', 
    coverFile: 'sendoff1.png', 
    accentColor: '#3b1f5e', 
    accentSoft: 'rgba(59, 31, 94, 0.40)', 
    leadTrack: 'Bondi', 
    type: 'final', 
    youtubeUrl: 'https://youtube.com/playlist?list=OLAK5uy_lw7W5lv8Uz9vZUA6mtJsVxqQNBHId-vPo&si=N43hFixeT54F_sBJ', 
    spotifyUrl: 'https://open.spotify.com/album/4RhuwNQZJIvs8LkzlOvrqE?si=fGzFH5sJRTGWe6_D95UmTQ&utm_source=copy-link',
    tracks: [
      { title: 'Overturn' }, 
    ...
    history: [ 
      { heading: 'Before Release', body: 'SENDOFF was set to be the conclusion project for the past 7 years of VEN\'s journey in music production. The project was designed to go back to the original, cosmic aesthetic from the early projects of VEN.' }, 
      { heading: 'Official Release', body: 'The compilation project was then released on May 29, 2026 with 17 tracks from all the previous projects and era except the SACCHARIN movie soundtrack. It was also released on streaming platforms the same day as it was released on studioseven YouTube channel.' }, 
      { heading: 'After Release', body: 'The supposed-to-be final project was then renamed to "The Best Project", signifying that there will be more projects and contents under VEN.' } 
    ],
  },
  {
    id: 'what-do-you-know', 
...
export const NEWS: NewsItem[] = [
  { 
    ...
    preview: 'singles "long enough" and "good" out July 24th.', 
    body: `some songs left behind. some songs left to be heard. some songs left to be felt. some songs left to be remembered. some songs left to be forgotten. some songs left to be loved. some songs left to be hated. some songs left to be known.
    
the singles "long enough" and "good" will be released on july 24th, 2026. out first on studioseven, then on all streaming platforms.`, 
    date: 'July 22, 2026', 
