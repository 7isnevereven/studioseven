...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tracks: [
      { title: 'In a Row', badges: ['POEM'] }, { title: 'Where Does This Bring Me?', badges: ['POEM']  }, { title: 'The Healer', badges: ['POEM']  }, { title: 'What Do You Know?', badges: ['POEM']  }, { title: 'To Those We Loved Before', badges: ['POEM']  }, { title: 'The Video', badges: ['POEM']  }, { title: 'The Video (Song)', badges: ['LEAD', 'SINGLE']  }, { title: 'Fear', badges: ['POEM']  }, { title: 'No Matter', badges: ['POEM']  }, { title: 'The Video (Extended)', badges: ['SINGLE', 'DELUXE']  },
    ],
