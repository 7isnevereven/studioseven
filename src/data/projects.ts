...
export const PROJECTS: Project[] = [
  {
    id: 'leaveitbehind', title: 'how many songs should i write so i can leave it all behind?', subtitle: '1st Single Project', releasedAt: '2026-07-24', releaseLabel: 'Released Jul 24, 2026', artistId: 'ven', coverFile: 'https://drive.google.com/file/d/1rvU-HWfotgFAWTOYnWo15Sd79k5ER7eS/view?usp=drive_link', accentColor: '#eed04c', accentSoft: 'rgba(31, 37, 94, 0.4)', type: 'project', featured: true, youtubeUrl: 'https://www.youtube.com/playlist?list=PLGsQPxrurQug',
    tracks: [
