    ...
    <div className={`modal-overlay ${isClosing ? 'closing' : ''}`} onClick={handleClose}>
      <div 
        ...
        style={{ 
          ...
          transition: 'all 0.4s cubic-bezier(0.2, 0.8, 0.2, 1)', /* Smooth expanding/resizing animation */
      ...
      >
        ...
        <div className="modal-content">
          ...
          <div className="modal-right" style={{ overflowX: 'hidden' /* Restricts side-to-side scrolling completely */ }}>
            
            {/* ── Poem View ── */}
            {selectedTrack ? (
              <div className="animate-in" style={{ display: 'flex', flexDirection: 'column' }}>
                <div style={{ position: 'sticky', top: 0, zIndex: 50, paddingBottom: 16 }}>
                  <button onClick={() => setSelectedTrack(null)} className="glass-btn glass-pill-sm" style={{ gap: 10, boxShadow: '0 8px 32px rgba(0,0,0,0.5)' }}>
